        ...
        red
          ...
          : dora
            ...
            : tile === "00"
              ...
              : "bg-gray-50 enabled:group-hover:bg-gray-200 enabled:hover:bg-gray-200 dark:bg-gray-500 dark:enabled:group-hover:bg-gray-600 dark:enabled:hover:bg-gray-600",
      )}
    >
      <Tile tile={tile} small={small} rotate={rotate} />
    </button>
