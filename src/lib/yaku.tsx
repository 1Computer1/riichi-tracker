...
export const YakuList = {
  ...
  国士無双十三面待ち: yaku({
    ...
    help: (
      <span>
        With thirteen orphans, win with a thirteen-sided wait. That is, your
        tenpai hand already has one of each terminal and honor.
      </span>
    ),
  }),
  純正九蓮宝燈: yaku({
    ...
    help: (
      <span>
        With nine gates, win with a nine-sided wait. That is, your tenpai hand
        is exactly <H.B>1112345678999</H.B>.
      </span>
    ),
  }),
  四暗刻単騎待ち: yaku({
    ...
    help: (
      <span>
        With four concealed triplets, win with a single-tile wait (making a
        pair, allowing ron).
      </span>
    ),
  }),
  ...
  国士無双: yaku({
    ...
    help: (
      <span>
        A hand with each of the thirteen different terminal and honor tiles plus
        an extra terminal or honor. In some rule variations, ron may be allowed
        on a closed kan of the winning tile.
      </span>
    ),
    example: [
      [
  ...
  九蓮宝燈: yaku({
    ...
    help: (
      <span>
        A hand consisting of the tiles <H.B>1112345678999</H.B> in the same suit
        plus an extra tile of the same suit.
      </span>
    ),
    example: [
      [
  ...
  四暗刻: yaku({
    ...
    help: (
      <span>
        Four concealed triplets (not called with pon, open kan, or ron).
      </span>
    ),
    example: [
      [
  ...
  緑一色: yaku({
    ...
    help: (
      <span>
        A hand composed using only green bamboo tiles (2, 3, 4, 6, 8) and/or the
        green dragon. Green dragon may be required in certain rule variations.
      </span>
    ),
  ...
  大七星: yaku({
    ...
    help: (
      <span>
        A seven pairs hand consisting of all seven of the honor tiles. Does not
        combine with all honors.
      </span>
    ),
    example: [
      [
  ...
  紅孔雀: yaku({
    ...
    help: (
      <span>
        A hand composed using only red bamboo tiles (1, 5, 7, 9) and/or the red
        dragon.
      </span>
    ),
  ...
  黒一色: yaku({
    ...
    help: (
      <span>
        A hand composed using only black circles tiles (2, 4, 8) and/or the wind
        tiles.
      </span>
    ),
  ...
  百万石: yaku({
    ...
    help: (
      <span>
        A full flush hand of characters, such that the numeric values sum up to
        at least 100.
      </span>
    ),
    example: [
  ...
  立直: yaku({
    ...
    help: (
      <span>
        Declare riichi with a 1000 point bet when in tenpai (one away from
        winning). Can no longer change your hand; draws are discarded unless
        they are a win.
      </span>
    ),
  }),
  ダブル立直: yaku({
    ...
    help: (
      <span>
        Declare riichi with a 1000 point bet when in tenpai on your first turn.
        Calls invalidate. Can no longer change your hand; draws are discarded
        unless they are a win.
      </span>
    ),
  }),
  一発: yaku({
    ...
    help: (
      <span>
        Additional <H>1</H> han if you win before your next discard after
        calling riichi. Calls invalidate.
      </span>
    ),
  }),
  門前清自摸和: yaku({
  ...
  嶺上開花: yaku({
    ...
    help: (
      <span>
        Win on the dead wall draw after calling kan. In three-player mahjong, a
        win on the dead wall draw after calling kita also counts.
      </span>
    ),
  }),
  搶槓: yaku({
  ...
  場風東: yaku({
    id: "場風東",
    name: "Prevalent Wind (East)",
    value: 1,
    basic: true,
  }),
  場風南: yaku({
    id: "場風南",
    name: "Prevalent Wind (South)",
    value: 1,
    basic: true,
  }),
  場風西: yaku({
    id: "場風西",
    name: "Prevalent Wind (West)",
    value: 1,
    basic: true,
  }),
  場風北: yaku({
    id: "場風北",
    name: "Prevalent Wind (North)",
    value: 1,
    basic: true,
  }),
  自風東: yaku({
  ...
  自風北: yaku({
    id: "自風北",
    name: "Seat Wind (North)",
    value: 1,
    basic: true,
  }),
  客風北: yaku({
    id: "客風北",
    name: "Guest Wind (North)",
    value: 1,
    basic: true,
  }),
  ...
  平和: yaku({
    ...
    help: (
      <span>
        A hand worth <H>0</H> fu based on its composition. That is, it contains
        only sequences, a non-yakuhai pair (not a dragon or round/seat wind),
        and a two-sided open wait.
      </span>
    ),
    example: [["1p", "2p", "3p", "4p"]],
  }),
  断么九: yaku({
    ...
    help: (
      <span>
        A hand composed of only tiles 2 through 8. This yaku may be closed only
        in certain rule variations.
      </span>
    ),
  ...
  十二落抬: yaku({
    ...
    help: (
      <span>
        A hand with four open sets (i.e. not including closed kan) waiting for a
        single tile to complete. Can win on tsumo or ron.
      </span>
    ),
    example: [
      ["1z", "1z"],
  ...
  一気通貫: yaku({
    ...
    help: (
      <span>
        The sequences <H.B>123</H.B>, <H.B>456</H.B>, <H.B>789</H.B> in a single
        suit.
      </span>
    ),
  ...
  混全帯么九: yaku({
    ...
    openMinus: true,
    help: (
      <span>All tile sets in the hand contains a terminal or an honor.</span>
    ),
  ...
  七対子: yaku({
    ...
    help: (
      <span>
        A hand consisting of seven pairs. An exception to the usual hand
        composition of four sets and a pair.
      </span>
    ),
    example: [
      [
  ...
  五門斉: yaku({
    ...
    help: (
      <span>
        A hand containing all five different suits (characters, circles, bamboo,
        winds, and dragons).
      </span>
    ),
    example: [
  ...
  三暗刻: yaku({
    ...
    help: (
      <span>
        Three concealed triplets (not called with pon, open kan, or ron). Other
        sets may be open.
      </span>
    ),
    example: [
  ...
  三連刻: yaku({
    ...
    help: (
      <span>
        A hand containing three triplets in the same suit where their number
        steps by one.
      </span>
    ),
  ...
  小三元: yaku({
    ...
    help: (
      <span>
        Two sets and a pair of each dragon. The <H>2</H> han from having two
        dragon triplets are still included.
      </span>
    ),
  ...
  混老頭: yaku({
    ...
    value: 2,
    help: (
      <span>A hand composed entirely out of terminal and honor tiles.</span>
    ),
  ...
  一色三順: yaku({
    ...
    openMinus: true,
    help: (
      <span>A hand containing three identical sequences in the same suit.</span>
    ),
  ...
  二盃口: yaku({
    ...
    help: (
      <span>
        Two separate instances of two identical sequences. Does not combine with
        seven pairs.
      </span>
    ),
    example: [
...
export const YakuReferenceSort: YakuReferenceItem[] = [
  ...
  otherRef({
    ...
    help: (
      <span>
        The round wind and/or the seat wind. Gain <H>1</H> han for each set.
        Gain <H>2</H> han if wind is both round and seat wind.
      </span>
    ),
    example: [["1z", "1z", "1z"]],
    basic: true,
  ...
  otherRef({
    ...
    help: (
      <span>
        At an exhaustive draw, a <H>mangan</H> is awarded if your discards are
        only terminals and honors and none were called by other players. This
        may be scored as a <H>mangan</H>, <H>5</H> han, etc. depending on rule
        variations.
      </span>
    ),
  }),
  ...
  otherRef({
    ...
    help: (
      <span>
        A dora indicator is flipped at the start of each hand, pointing to the
        dora. Another dora indicator is flipped per kan. Ura dora indicators
        underneath are revealed on a riichi win. Red fives are also dora. Each
        dora in hand counts as <H>1</H> han.
      </span>
    ),
    example: [
      [
  ...
  otherRef({
    ...
    help: (
      <span>
        In three-player mahjong, north tiles that were called counts as dora. In
        certain rule variations, north instead counts as yakuhai for every
        player.
      </span>
    ),
    example: [["4z"]],
